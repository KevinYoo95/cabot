...
class ZigZag_Ver4():
    def __init__(self):
		...
		self.phase = 0
		self.resolution =0
		rospy.init_node("LHSsalgorithmON")
		...
		###############################3 INIT ##########################################
		#print(self.height,self.width,self.resolution,self.map_array)
		#rospy.sleep(1)
...
######################################################################################################
    def draw_(self):
		...
		for i in range(50):	
			...
			#print(int(self.radius/self.resolution))
    ...
    def draw_lines(self,starting_array): 
		map_state = 0
		x,y = divmod(starting_array,self.height)
#		x,y = zig3.array_to_pixel(starting_array)
		py = y
		line =[]
		line_only1 = []

	#	print("lengthofmap_array",len(self.map_array))
	#	print("y",py)
	#	print("map_state",map_state)
		for i in range(self.height):
			#print("ltetsgo",y*self.height+i)
