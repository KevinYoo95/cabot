...
class ZigZag_Ver5():
	...
	def distance_straight(self):
		...
		while(((self.line_coor[self.ith][0] - self.robot_pose[0])*(self.line_coor[self.ith][0] - self.robot_pose[0]) + (self.line_coor[self.ith][1]-self.robot_pose[1])*(self.line_coor[self.ith][1]-self.robot_pose[1]) <self.dis*self.dis) ):
		...
		#		flag = 1				
		#	self.estimate_current_position()
		#	if(((self.line_coor[self.ith][0] - self.robot_pose[0])*(self.line_coor[self.ith][0] - self.robot_pose[0]) + (self.line_coor[self.ith][1]-self.robot_pose[1])*(self.line_coor[self.ith][1]-self.robot_pose[1]) >self.dis*self.dis) or (self.line_coor[self.ith + self.jumhyul_dis][2]!=0)):
		#		break
		#	self.ith= self.ith+self.jumhyul_dis
	...
	def distance_evaluation(self):
		self.estimate_current_position()
		while(((self.line_coor[self.ith][0] - self.robot_pose[0])*(self.line_coor[self.ith][0] - self.robot_pose[0]) + (self.line_coor[self.ith][1]-self.robot_pose[1])*(self.line_coor[self.ith][1]-self.robot_pose[1]) <self.dis*self.dis) and (self.line_coor[self.ith][2]==self.line_coor[self.ith+self.jumhyul_dis][2])):
			self.ith= self.ith+self.jumhyul_dis
			self.estimate_current_position()
